...
os.chdir('C:/VScode_programs/Python/lib/tsis8')
...
game_over = font.render("Razmotalsya", True, BLACK)
...
while True:
    ...
    coinss = font_small.render("Coins: " + str(COINS_SCORE), True, BLACK)
    ...
    for entity in coins:
        entity.move()
        DISPLAYSURF.blit(entity.imsc, entity.rect)
